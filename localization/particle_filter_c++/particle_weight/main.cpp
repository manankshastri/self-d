...
int main() {
  ...
  weight1 = multi_prob(sig_x, sig_y, x_obs, y_obs, mu_x, mu_y);
  ...
  weight2 = multi_prob(sig_x, sig_y, x_obs, y_obs, mu_x, mu_y);
  // should be around 0.00683644777551 rounding to 6.84E-3
  ...
  weight3 = multi_prob(sig_x, sig_y, x_obs, y_obs, mu_x, mu_y);
