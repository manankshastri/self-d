...
x_trajectory_1, y_trajectory_1 = run(robot, 0.1)
x_trajectory_2, y_trajectory_2 = run(robot, 0.3)
n = len(x_trajectory_1)

fig, (ax1, ax2) = plt.subplots(2, 1, figsize=(8, 8))
ax1.plot(x_trajectory_1, y_trajectory_1, 'g', label='P controller')
ax1.plot(x_trajectory_1, np.zeros(n), 'r', label='reference')
